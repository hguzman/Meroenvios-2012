        ...
        <div id="todo">            
            ...
            <div id="content">
                ...
                <div id="centro">
                    <div id="informacion">
                        <h2>Visión</h2><br/>
Metroenvios Ltda., se proyecta para el año 2015, como la mejor alternativa  de mensajería especializada  a nivel rural y urbano de la región caribe. Destacándose por la seriedad, cumplimiento, confiabilidad y excelencia en  sus servicios, enmarcados dentro de un sistema integral de gestión.
                    </div>
                </div>
            </div>
